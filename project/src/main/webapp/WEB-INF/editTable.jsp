...
<body>
    ...
    <!-- Header -->
     <header class=" navbar-expand-lg navbar-light text-black py-3 mb-5" style="background-color: #ECF9FF">
        <div class="container">
    ...
    <!-- Footer -->
    <footer class=" text-black py-5 mt-5" style="background-color: #ECF9FF">
